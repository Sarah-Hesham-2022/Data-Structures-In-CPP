...
int main()
{
    ...
    cout<<n2.Search(89)<<endl;
    cout<<endl<<"Now let's try with strings"<<endl;
    List<string>n3("Five",4);
    n3.addToHead("Eight");
    n3.addToTail("Nine");
    cout<<n3<<endl;
    List<string>::Iterator *it3;
    it3=new List<string>::Iterator(n3.Begin());
    try
    {
        (*it3)++;
    }
    catch(List<string>::Iterator::IncrementError)
    {
        cout<<"The iterator is pointing after last element,can't increment::ERROR"<<endl;
    }
    n3.Insert("Two",it3);
    ...
    catch(List<string>::Iterator::DecrementError)
    {
        cout<<"The iterator is pointing at first element,can't decrement::ERROR"<<endl;
    }
    try
    ...
    it4=new List<string>::Iterator(n3.End());
    ...
    n4.printInReverse();
    cout<<n4.Search("EightyEight")<<endl;
    cout<<n4.Search("EightyNine")<<endl;
    return 0;
}
